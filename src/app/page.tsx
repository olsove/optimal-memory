      ...
      <header className="sticky top-0 z-10 bg-white/90 dark:bg-gray-950/90 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          ...
          <div className="flex-1 flex gap-2 justify-end">
            ...
            <Button
              onClick={() =>
                router.push('https://github.com/olsove/optimal-memory')
              }
            >
              <GitBranch className="h-[1.2rem] w-[1.2rem] transition-all" />
            </Button>
          </div>
        </div>
      </header>
      ...
      <main className="grow flex flex-col justify-center items-center px-4 py-4 md:py-8">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              A guide based on years of experience where I have been tuning bad SQL code. I hope you find the content useful and that you will learn to write performant SQL code.
            </motion.p>
          </div>
        ...
        <div className="container mx-auto px-4 py-3 text-center text-gray-600 dark:text-gray-400">
          <div className="flex justify-end items-center space-x-4">
            <div className="flex text-sm text-right gap-3">
              <p>
                Built with ❤️ by <strong>Ove Olsen</strong>
              </p>
            </div>
          </div>
        </div>
