...
interface CodeHighlighterProps {
  ...
  // Customise the animated indicator colour
...
export const CodeHighlighter: React.FC<CodeHighlighterProps> = ({
  ...
  tabElements.forEach((child, index) => {
    ...
    // Use provided name if exists; otherwise, fall back to the language or default label.
  ...
  // Determine the indicator colour based on whether it is a hex value or a Tailwind class.
